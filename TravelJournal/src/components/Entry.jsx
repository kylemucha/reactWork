export default function Entry () {
    return (
        <div className="location-entry">
            <img className="location-picture" src="https://scrimba.com/links/travel-journal-japan-image-url"></img>
            <div className="location-information">
                <img className="location-marker" src="src/pictures/marker.png"></img>
                <span>J A P A N</span>
